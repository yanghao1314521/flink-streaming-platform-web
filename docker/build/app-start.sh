cd /data/projects/flink-1.14.6
./bin/start-cluster.sh 
cd  /data/projects/ && chown  -R root:root flink-streaming-platform-web
...
touch /data/projects/flink-streaming-platform-web/logs/info.log
echo  "...............start............" >> /data/projects/flink-streaming-platform-web/logs/info.log
